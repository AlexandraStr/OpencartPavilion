...
<script type="text/javascript">
    ...
    function GetSelector(url,selector,single) {
        ...
        url = "index.php?op=css&url="+encodeURIComponent(url)+'&single='+single+'&cd='+Date.now()+'&domain=<?php  echo @$D0["\x68\157\163\164"]; ?>
';
        iSelector = selector;
...
<script type="text/javascript">
    ...
    function UpdateLog()
    {
        $.get('index.php?op=feed',false, function(data) {
            ...
            logfeed.append(data);
            <?php  if (!(@$_GET["\x72\157\165\164\x65"] !== "\167\151\x7a\141\x72\x64\62\170")) { goto d6eb; } ?>
            $(".log").show();
            <?php  d6eb: ?>
