<ul id="menu">
 ...
 <li><a class="parent" target="_blank" href="<?php echo HTTP_SERVER.'liveimport' ?>"><img title="LiveImport" src="liveimport/lib/static/icon.png" style="vertical-align:middle;"> <span><font color="#8de43c">Live</font>Import</span></a></li> 
