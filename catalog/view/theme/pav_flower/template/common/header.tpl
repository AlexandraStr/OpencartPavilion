...
<link href="catalog/view/theme/default/stylesheet/customer.css" rel="stylesheet">
        ...
        <div class="container">
         ...
         <!--    <div class="center-header-block"> -->
           ...
           <!--     </div>  -->
              ...
              <div class="pull-right col-lg-5 col-md-5 clearfix">
                <div class="wishlist ">
                  <a href="<?php echo $wishlist; ?>" id="wishlist-total" title="<?php echo $text_wishlist; ?>"><i class="fa fa-heart"></i> <span><?php echo $text_wishlist; ?></span></a>
                </div>
                <div class="cart-top">
                  <?php echo $cart; ?>
                </div>
...
<div class="nullblock clearfix"></div>
  <!-- sys-notification -->
