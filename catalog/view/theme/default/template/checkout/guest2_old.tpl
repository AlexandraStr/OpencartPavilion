  ...
  <div class="col-sm-12">
    <fieldset id="address">
      ...
      <div class="form-group shipping-city required hide">
        ...
        <select name="city_ref" id="input-shipping-city" class="form-control"></select>
      </div>
      <div class="form-group shipping-address-1 required hide">
        ...
        <select name="warehouse_name" id="input-shipping-address-1" class="form-control"></select>
      </div>
...
<script type="text/javascript"><!--
            ...
            success: function(json) {
                ...
                if ( json.length > 0) {
                    ...
                    for (i = 0; i < json.length; i++) {
                        ...
                        html += '<option value="' + json[i]['city_ref'] + '"';
                ...
                $('#address select[name=\'city_ref\']').html(html);
            },
    ...
    //--></script>
<script type="text/javascript"><!--
    $('#address select[name=\'city_ref\']').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                $('#address select[name=\'warehouse_name\']').html(html);
