<?php
class ControllerCheckoutGuest2 extends Controller {
	public function index() {
		...
		$this->response->setOutput($this->load->view('checkout/guest2', $data));
	}
	...
	//		if ((utf8_strlen(trim($this->request->post['city_ref'])) < 2) || (utf8_strlen(trim($this->request->post['city_ref'])) > 128)) {
		...
		if (!$json) {
			...
			if ($this->session->data['guest']['shipping_address']) {
				...
				if (isset($this->request->post['address_1'])) {
                    ...
                    $this->session->data['shipping_address']['address_1'] = $zone_info['name']." ".explode(",",$this->request->post['city'])[1]." ".$this->request->post['warehouse'];
                }
				$this->session->data['shipping_address']['address_2'] = $this->request->post['address_2'];
				$this->session->data['shipping_address']['postcode'] = $this->request->post['postcode'];
				$this->session->data['shipping_address']['city'] = explode(",",$this->request->post['city'])[1];
                $this->session->data['shipping_address']['warehouse'] = $this->request->post['warehouse'];
                $this->session->data['shipping_address']['cost'] = $this->request->post['cost'];
